...
{
    public partial class ControlerrCorrectionContractsView : UserControl
    {
        string Operation => "CorectieContract";
...
#endif
        public ControlerrCorrectionContractsView(IDbContextFactory<AppDbContext> db, ISessionContext session)
        {
            InitializeComponent();
            _dbFactory = db;
        ...
        private void ControlerrCorrectionContractsView_Load(object sender, EventArgs e)
        {
