...
namespace api_itm.UserControler.Contracts.Cessation___Reactivation
{
    public partial class ControlerTerminationContractsView : UserControl
    {
...
#endif 
        public ControlerTerminationContractsView( IDbContextFactory<AppDbContext> db, ISessionContext session)
        {
            InitializeComponent();
            _dbFactory = db;
        ...
        private void ControlerTerminationContractsView_Load(object sender, EventArgs e)
        {
 ...
 string authorIdStr)
        ...
        private async Task LoadContractsAsync()
        {
            ...
            var baseRows = await (
                ...
                where rs.RegesEmployeeId != null && c.ContractStatusId == 4 // 2 = contracte incetate
